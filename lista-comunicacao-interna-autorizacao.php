...
<div class="span8 conteudo">
	...
	<ul class="nav nav-tabs nav-justified">
      ...
      <li role="presentation" class="active"><a href="lista-comunicacao-interna-autorizacao.php?id=">P/ Autorização</a></li>
...
<br>
	<div class="page-header">
		...
		<h3>Comunicações Internas - Para Autorização</h3><br />
			...
			<li class="media">
				<div class="media-body">
					<h4 class="media-heading">CI Nº 740 - Contratação de Estagiário</h4>
						...
						Situação: <span class="label label-warning">Para Autorização</span>
				</div><br /><br /><br />
